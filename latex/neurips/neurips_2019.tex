...
We hypothesize that for most programming languages, there is a short query which unambiguously identifies the canonical entity and furthermore, it is possible to learn a program which synthesizes this query in a data-driven manner.
...
\begin{figure}[H]
    ...
    \caption{This graph was parsed from the following comment:
        ``The advantages to using this container over a \footnotesize\inline{Map<K, Collection<V>{}>} is
